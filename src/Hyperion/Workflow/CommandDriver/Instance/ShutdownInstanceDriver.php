...
/**
 * Shutdown (stop) an instance
 */
class ShutdownInstanceDriver extends AbstractCommandDriver implements CommandDriverInterface
{
    ...
    public function execute()
    {
        ...
        // Spawn the instances
        $report = $this->service->getInstanceManager()->stopInstances($instanceFilter);
