 ...
 */
class RestartInstanceDriver extends AbstractCommandDriver implements CommandDriverInterface
{
    ...
    public function execute()
    {
        ...
        // Spawn the instances
        $report = $this->service->getInstanceManager()->restartInstances($instanceFilter);
